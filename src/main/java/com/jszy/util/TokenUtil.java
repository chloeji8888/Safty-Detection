...
public class TokenUtil {
	 ...
	 * 签名秘钥(唯一秘钥，可以用密码做为秘钥)
	 */
	public static final String SECRET = "jszyTotz2020";
	...
	public static void main(String[] args) {
		String token = "eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiJhZG1pbiIsImlhdCI6MTU3NDkzNDUxMiwiZXhwIjoxNTc0OTcwNTEyfQ.gS8xX_JFMAR2UotycoC6yZ3WdEAme0h41EoZYC5DklI";
